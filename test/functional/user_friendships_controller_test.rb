...
context "@new" do 
 		...
 		context "when logged in" do
 			...
 			should "set a flash error if the friend_id params is method" do 
 				get :new, {}
 			...
 			should "assign a new user friendship to the current user" do 
 				get :new, friend_id: users(:jim)
 	...
 	context "#accept" do
		context "when not logged in" do
 		...
 		context "when logged in" do 
 			setup do
 				#@user_friendship = UserFriendship.request users(:jason), users(:jim)
 				@friend = create(:user)
